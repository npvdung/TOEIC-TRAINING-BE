...
router.post('/profile/avatars', authorize(), uploadAvatar.single("file"), updateAvatar)
...
async function getAvatar(req, res, next) {
    const avatarPath = path.join(global.appRoot, AVATAR_PATH, req.params.avatarName);
